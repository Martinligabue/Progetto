...
public class UserTest extends Streams {//aggiungere lista personalizzata?
	...
	public void testCustomList() {
		...
		list1.add(game1);
		User primoUtente = new User.UserBuilder("john88", "John Wick").setGames(game1, list1)
				.build();
		assertThat(primoUtente.getGames().contains(game1));
	}
	@Test
	public void testAddGames() {
		...
		User secondoUtente = new User.UserBuilder("bob", "Robert").setGames(new Game ("Klondike", 0), shop.getGameList()).build();
